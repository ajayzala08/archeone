...
----------------------------------------Executed On Dev Environment-------------------------------------------
----------------------------------------Executed On QA Environment-------------------------------------------
----------------------------------------Added by PP on 04-10-23-----------------------------------Start--------
ALTER TABLE Teammst
ADD TeamName varchar(255);

----------------------------------------Added by PP on 04-10-23-----------------------------------End----------

----------------------------------------Executed On Dev Environment-------------------------------------------

----------------------------------------Added by TS on 12-10-23-----------------------------------Start----------

ALTER TABLE usermst ALTER COLUMN MiddleName nvarchar(100) NULL;

----------------------------------------Added by TS on 12-10-23-----------------------------------End----------
----------------------------------------Executed On Dev Environment-------------------------------------------