$(document).ready(function () {
    ...
    var inputTag = $('<input type="text" id="input-tag" class="ml-2 ' + className+ '" style="border: none;outline: none;padding: 0.375rem;font-weight: 400;color: #495057;background-color: #fff;background-clip: padding-box;" onkeydown="handleKeyDown(event)"/>');
