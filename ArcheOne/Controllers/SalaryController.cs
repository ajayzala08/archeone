    ...
    public class SalaryController : Controller
    {
        ...
        public async Task<IActionResult> DownloadSalarySlip(int id)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                PdfPCell designationValueCell = new PdfPCell(new Phrase($"{salaryDetail.userDetail.Designation}", fontTableRow));
                ...
                PdfPCell departmentValueCell = new PdfPCell(new Phrase($"{salaryDetail.userDetail.Department}", fontTableRow));
