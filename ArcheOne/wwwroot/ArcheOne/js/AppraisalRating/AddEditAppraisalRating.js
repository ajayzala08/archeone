...
function TotalCountChange() {
    debugger
    var sum = ($("#txtQualityOfWork").val()) + ($("#txtGoalsNachievement").val()) + ($("#txtWrittenNVerbalSkill").val()) + ($("#txtInitiative").val()) + ($("#txtTeamWorkNLeaderShip").val()) + ($("#txtProblemsolveAbility").val()) + ($("#txtAttendanceRegularization").val());
