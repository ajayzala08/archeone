                    ...
                    { data: "skills", title: "Skills" },
                    {
                        ...
                        render: function (data, type, row) {
                            if (row.flowStatus == "Interview_Info") {
                                ...
                                return '<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modal-default" onclick="ShowScheduleInterview(' + row.id + ',\'' + row.fullName + '\',false)"><i class="fa fa-box-open"></i> Offer Given</button>';
                            } else if (row.flowStatus == "To_Be_Join") {
                                return '<button type="button" class="btn btn-secondary btn-block" data-toggle="modal" data-target="#modal-default" onclick="ShowScheduleInterview(' + row.id + ',\'' + row.fullName + '\',false)"><i class="fa fa-clock"></i> To Be Join</button>';
