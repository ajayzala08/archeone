    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> AddEditUser(int Id)
        {
            ...
            try
            {
                ...
                var DesignationList = await GetDesignationListByRoleAndDepartment(2, 1);
                userAddEditReqViewModel.DesignationList = DesignationList.Data;
        ...
        public async Task<IActionResult> UserListByRoleId(int? RoleId)
        {
            ...
            try
            {
                ...
                {
                    userList = await _dbRepo.UserMstList().Where(x => x.RoleId == RoleId).Select(x => new { x.Id, x.FirstName, MiddleName = x.MiddleName == null || string.IsNullOrEmpty(x.MiddleName) ? "" : x.MiddleName, x.LastName }).ToListAsync();
                }
